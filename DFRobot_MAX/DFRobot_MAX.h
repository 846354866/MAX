...
public:
	DFRobot_MAX();
	DFRobot_MAX(SoftwareSinglebus *bus_);
	...
	void rgbLed(uint8_t num, uint8_t r, uint8_t g, uint8_t b);

/********************************************************************************/
//****************************electric motor************************************//
/********************************************************************************/
	void advance(uint8_t speed_l, uint8_t speed_r);
	
	void retreat(uint8_t speed_l, uint8_t speed_r);
